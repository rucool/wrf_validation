...
def plot_heatmap(start_date, end_date, buoy, height, ws_df):
    ...
    for ii in range(0, 4):
        ...
        plt.title('Wind Speeds at ' + buoy[0] + ' at ' + str(height[0]) + 'm ' + start_date.strftime("%B %Y"),
                  fontsize='large')
...
#     metric_frame = pd.DataFrame(metric_frame)
#
#     metric_frame.to_csv('~/PycharmProjects/covid19/ASOSB_monthly_' + str(height[0]) + 'm_' + buoy[0] + '_' +
