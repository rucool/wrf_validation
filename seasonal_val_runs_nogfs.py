...
Last modified: Lori Garzio 8/8/2022
Run RU-WRF seasonal validation at specified validation locations. Creates heat maps and timeseries plots, remove GFS.
"""
...
def plot_val_time_series(start_date, end_date, buoy, height, ws_df, dt_df, season, save_dir):
    ...
    sdir = os.path.join(save_dir, end_date.strftime("%Y"), season[-1])
...
def plot_heatmap(start_date, end_date, buoy, height, ws_df, season, save_dir):
    ...
    wind_speeds = [wrf_ws, nam_ws, hrrr_ws]
    wind_speeds_b = [wrf_ws_b, nam_ws_b, hrrr_ws_b]
    model_names = ['RU WRF', 'NAM', 'HRRR']
    model_names_dir = ['RUWRF', 'NAM', 'HRRR']
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('-y', '--year',
                            ...
                            default=2021,
                            type=int,
                            help='Year for run in YYYY ')

    arg_parser.add_argument('-sn', '--season',
                            dest='ssn_code',
                            default='winter',
                            type=str,
                            help='season for run, valid option are, summer, fall, winter, spring ')
    ...
    arg_parser.add_argument('-save_dir',
                            default='/www/web/rucool/windenergy/ru-wrf/validation/seasonal_nogfs',
                            type=str,
