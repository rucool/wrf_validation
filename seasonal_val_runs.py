...
def main(args):
    ...
    plot_heatmap(start_date, end_date, buoy, height, obs_wrf_nam_hrrr_gfs_df, season, save_dir)
    plot_val_time_series(start_date, end_date, buoy, height, obs_wrf_nam_hrrr_gfs_df, obs_wrf_nam_hrrr_gfs_df['time'], season, save_dir)
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('-save_dir',
                            default='/www/web/rucool/windenergy/ru-wrf/validation/seasonal',
                            type=str,
